...
ifeq ($(config),release)
  ...
  ALL_ASMFLAGS       += $(ASMFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM)
  ALL_CFLAGS         += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM)
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM)
  ALL_OBJCFLAGS      += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM)
  ALL_OBJCPPFLAGS    += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM)
...
ifeq ($(config),debug)
  ...
  INCLUDES           += -I"../../src/host/lua-5.3.0/src"
  ALL_CPPFLAGS       += $(CPPFLAGS) -MMD -MP -MP $(DEFINES) $(INCLUDES)
  ALL_ASMFLAGS       += $(ASMFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ $(MPARAM)
  ALL_CFLAGS         += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ $(MPARAM)
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ $(MPARAM)
  ALL_OBJCFLAGS      += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ $(MPARAM)
  ALL_OBJCPPFLAGS    += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ $(MPARAM)
  ALL_RESFLAGS       += $(RESFLAGS) $(DEFINES) $(INCLUDES)
