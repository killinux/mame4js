...
ifeq ($(config),release)
  ...
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM) -std=gnu99
  ALL_CXXFLAGS  += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM) -std=gnu99
  ALL_OBJCFLAGS += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -O0 $(MPARAM) -std=gnu99
...
ifeq ($(config),debug)
  ...
  INCLUDES  += -I../../src/host/lua-5.3.0/src
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ -std=gnu99
  ALL_CXXFLAGS  += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ -std=gnu99
  ALL_OBJCFLAGS += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -Wall -Wextra -g4 --source-map-base http://121.5.59.140/mame/mame/ -std=gnu99
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
